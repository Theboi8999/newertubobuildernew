...
const OTTOMAN_EXTRA_PARTS: RbxPart[] = [
  ...
  {
    name: 'RoofMain', size: { x: 33, y: 0.6, z: 31 },
    position: { x: 0, y: 23.5, z: 0 },
    color: 'Dark red', material: 'pebble', anchored: true, transparency: 0,
  },
  {
    name: 'FasciaF', size: { x: 33, y: 1.0, z: 0.4 },
    position: { x: 0, y: 23.0, z: 15.5 },
    color: 'Reddish brown', material: 'woodplanks', anchored: true, transparency: 0,
  },
  {
    name: 'FasciaB', size: { x: 33, y: 1.0, z: 0.4 },
    position: { x: 0, y: 23.0, z: -15.5 },
    color: 'Reddish brown', material: 'woodplanks', anchored: true, transparency: 0,
  },
  {
    name: 'FasciaL', size: { x: 0.4, y: 1.0, z: 31 },
    position: { x: -15.5, y: 23.0, z: 0 },
    color: 'Reddish brown', material: 'woodplanks', anchored: true, transparency: 0,
  },
  {
    name: 'FasciaR', size: { x: 0.4, y: 1.0, z: 31 },
    position: { x: 15.5, y: 23.0, z: 0 },
    color: 'Reddish brown', material: 'woodplanks', anchored: true, transparency: 0,
  },
]
